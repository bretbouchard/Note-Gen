...
class ScaleInfo(BaseModel):
    ...
    def validate_scale_degrees(cls, scale_degrees: Optional[List[ScaleDegree]]) -> List[ScaleDegree]:
        if scale_degrees is not None and not all(isinstance(degree, ScaleDegree) for degree in scale_degrees):
