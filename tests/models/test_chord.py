...
def test_chord_quality_types() -> None:
    ...
    major_chord = Chord(root=Note(name='C', octave=4), notes=[Note(name='C', octave=4), Note(name='E', octave=4), Note(name='G', octave=4)], quality=ChordQualityType.MAJOR)
    ...
    minor_chord = Chord(root=Note(name='A', octave=4), notes=[Note(name='A', octave=4), Note(name='C', octave=4), Note(name='E', octave=4)], quality=ChordQualityType.MINOR)
    ...
    diminished_chord = Chord(root=Note(name='B', octave=4), notes=[Note(name='B', octave=4), Note(name='D', octave=4), Note(name='F', octave=4)], quality=ChordQualityType.DIMINISHED)
    ...
    augmented_chord = Chord(root=Note(name='C', octave=4), notes=[Note(name='C', octave=4), Note(name='E', octave=4), Note(name='G#', octave=4)], quality=ChordQualityType.AUGMENTED)
    ...
    half_diminished_chord = Chord(root=Note(name='D', octave=4), notes=[Note(name='D', octave=4), Note(name='F', octave=4), Note(name='Ab', octave=4)], quality=ChordQualityType.HALF_DIMINISHED)
    ...
    dominant_chord = Chord(root=Note(name='G', octave=4), notes=[Note(name='G', octave=4), Note(name='B', octave=4), Note(name='D', octave=4)], quality=ChordQualityType.DOMINANT)
    ...
    major_seventh_chord = Chord(root=Note(name='C', octave=4), notes=[Note(name='C', octave=4), Note(name='E', octave=4), Note(name='G', octave=4), Note(name='B', octave=4)], quality=ChordQualityType.MAJOR_SEVENTH)
    ...
    minor_seventh_chord = Chord(root=Note(name='A', octave=4), notes=[Note(name='A', octave=4), Note(name='C', octave=4), Note(name='E', octave=4), Note(name='G', octave=4)], quality=ChordQualityType.MINOR_SEVENTH)
    ...
    diminished_seventh_chord = Chord(root=Note(name='B', octave=4), notes=[Note(name='B', octave=4), Note(name='D', octave=4), Note(name='F', octave=4), Note(name='Ab', octave=4)], quality=ChordQualityType.DIMINISHED_SEVENTH)
    ...
    augmented_seventh_chord = Chord(root=Note(name='C', octave=4), notes=[Note(name='C', octave=4), Note(name='E', octave=4), Note(name='G#', octave=4), Note(name='B', octave=4)], quality=ChordQualityType.AUGMENTED_SEVENTH)
